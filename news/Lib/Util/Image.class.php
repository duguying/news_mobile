...
class Image {
     ...
     * @return void
     */
    static function thumb($image, $thumbname='thumb', $type='', $maxWidth=200, $maxHeight=50, $interlace=true) {
        // 获取原图信息
        ...
        if ($info !== false) {
            ...
            // 生成显示图片 changed by rexlee//TODO
            $imageFun = 'image' . ($type == 'jpg' ? 'jpeg' : $type);
            $imageFun($thumbImg);
            header("Content-type: image/$type");
            header("Author: rexlee[duguying2008@gmail.com]");
